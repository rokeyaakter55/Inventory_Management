...
<a href="asset/index-2.html"><span style="font-size:30px;color:#fff;font-weight:900;">Inventory Management System</span></a>
</div>
...
<div class="footer-contacts-widget fl-wrap">
    ...
    <ul class="footer-contacts fl-wrap">
        <li><span><i class="fa fa-envelope-o"></i> Mail :</span><a href="asset/#" target="_blank">yourmail@domain.com</a></li>
        <li> <span><i class="fa fa-map-marker"></i> Adress :</span><a href="asset/#" target="_blank">USA 27TH Brooklyn NY</a></li>
        <li><span><i class="fa fa-phone"></i> Phone :</span><a href="asset/#">+7(111)123456789</a></li>
    </ul>
</div>
</div>
</div>
