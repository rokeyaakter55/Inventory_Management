...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    <section class="content-header" >
     ...
     <ol class="breadcrumb">
      ...
      <li><a href="new_product.php"> Stock Out product </a></li>
    </ol>
  </section>
  <!-- Main content -->
  <section class="content" style="min-height: 76vh";>
   ...
   <select class="form-control" onChange="get_data()" required="" id="code">
              ...
              <div class="col-md-5">
             Customer Info:<input required="" type="text" autocomplete="off" name="customer_info" class="form-control"> 
            </div>
             <div class="col-md-3">
  ...
  <tfoot>
    <tr>
      ...
      <th >
        <input type="text" readonly="" name="sub_total" id="sub">
      </th>
      <th></th>
    </tr>
    <tr>
      ...
      <th id="dis">
        <input type="text" required="" name="discount" autocomplete="off" onkeyup="dis_calculate()" id="d" value="0" class="form-control">
      </th>
      <th></th>
    </tr>
    <tr>
      <th class="text-right" colspan="4">Total</th>
      <th ><input type="text" readonly="" id="to" name="total" class="form-control"></th>
      <th></th>
    </tr>
    <tr>
    ...
    $('#inc').val(i)
      ...
      $.ajax({
        ...
        success: function(data){
          ...
          var ht='<tr id="r_'+i+'">'
          ht+='<td>'+i+'</td>'
          ht+='<td><input type="text" readonly class="form-control" value="'+data.name+'"><input type="hidden" name="productid" class="form-control" value="'+data.id+'"></td>'
          ht+='<td><input onkeyup="calculate('+i+')" id="p_'+i+'"  value="'+data.price+'" readonly="" type="text"  class="form-control" ></td>'
          ht+='<td><input onkeyup="calculate('+i+')" id="q_'+i+'" value="0" autocomplete="off" type="text" class="form-control" name="quantity"tabindex="'+i+'"></td>'
