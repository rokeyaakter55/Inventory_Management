...
$data=$obj->get_product_stock_out();
  ?>
<div class="wrapper">
  <?php
                ...
                <table id="example1" class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="stock_out_edit.php?id=<?php echo $d['id']?>" class="btn btn-primary">Edit</a>
                        <a href="stock_out_delete.php?id=<?php echo $d['id']?>" class="btn btn-danger">Delete</a>
                      </td>
                    </tr>
                    <?php } ?>
                  </tbody>
