...
<a href="index-2.html"><span style="font-size:30px;color:#fff;font-weight:900;">GotDial</span></a>
</div>
...
<li>
    <a href="listing.html">Listings <i class="fa fa-caret-down"></i></a>
    <!--second level -->
    <ul>
        <li><a href="#">Listings Submenu</a></li> 
        <li><a href="#">Listings Submenu 1</a></li>
        <li><a href="#">Listings Submenu 2</a></li>
        <li>
            <a href="#">Listings Submenu 3 <i class="fa fa-caret-down"></i></a>
            <!--third  level  -->
            <ul>
                <li><a href="#">Listings Submenu Sub</a></li> 
				<li><a href="#">Listings Submenu Sub 1</a></li>
				<li><a href="#">Listings Submenu Sub 2</a></li>
            </ul>
            <!--third  level end-->
        </li>
    </ul>
...
<div class="gallery-item">
    <div class="grid-item-holder">
        <div class="listing-item-grid">
            <img  src="images/h_restaurants.jpg" alt="">
            <div class="listing-item-cat">
                <h3><a href="listing.html">Restaurants</a></h3>
...
<div class="about-widget" style="text-align:center;">
    <span style="font-size:30px;color:#fff;font-weight:900;float:left;">GotDial</span>
</div>
</div>
<div class="col-md-4">
<div class="copyright"> &#169; GotDial 2018 .  All rights reserved.</div>
</div>
<div class="col-md-4">
